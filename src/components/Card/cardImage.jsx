...
export function SecondaryCard() {
  ...
  useEffect(() => {
    const incomeControls = animate(0, 2450122, {
      duration: 1,
      onUpdate(value) {
    ...
    const worstControls = animate(0, 5992156, {
      duration: 0.8,
      onUpdate(value) {
        const num = value.toFixed().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
    ...
    >
      ...
      >
        <div className="flex items-center gap-2 lg:gap-3.5">
          <img
            ...
            alt="earn"
          />
          <p className="text-[9px] sm:text-sm lg:text-base">Number of Users</p>
        </div>
        <div className="flex items-center gap-2 lg:gap-3.5">
      ...
      >
        <div className="flex items-center gap-2 lg:gap-3.5">
          <img
            ...
            alt="earn"
          />
          <p className="text-[9px] sm:text-sm lg:text-base">Time Spent Shopping</p>
        </div>
        <div className="flex items-center gap-2 lg:gap-3.5">
      ...
      >
        <div className="flex gap-6 items-center">
          <p className="text-[9px] sm:text-sm lg:text-base">Monthly Activity</p>
          <img
